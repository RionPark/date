...
public class DateTest{
    ...
    public void testStringTwo() {
        IDate date = new Date(2011, 10, 31);
    ...
    public void testAddDays2() {
        IDate date = new Date(1938, 1, 10);//Donald Knuth
        date.addDays(100000);
    ...
    public void testAddWeeks() {
        IDate date = new Date(1903, 12, 28);//Von Neumann
        date.addWeeks(200);
    ...
    public void testIsLeapYearBasic() {
        IDate date = new Date(1995, 5, 5);
        IDate date2 = new Date(2008, 2, 6);
